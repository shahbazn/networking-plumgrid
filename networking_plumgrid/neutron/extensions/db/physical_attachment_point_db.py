...
def update_pap(context, pap_id, pap):
    ...
    #Update corresponding enteries in interfaces table
...
def _make_pap_dict(pap):
    ...
    pap_dict = {"id": pap.id,
                ...
                "hash_mod": pap.hash_mod,
                "lacp_off": pap.lacp_off,
